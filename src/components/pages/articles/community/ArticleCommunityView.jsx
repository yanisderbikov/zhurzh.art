...
export default function ArticleCommunityView({ styles, getImage, heroBackgroundUrl, mockupSrc }) {
    return (
        <>
            <div
            ...
            <div className={styles.wrap}>
                <div className={styles.main}>
                    <img src={getImage(1)} className={styles.imageNoGap}/>
                    ...
                    <img src={getImage(8)} className={styles.image}/>
                    ...
                    <img src={getImage(9)} className={styles.image}/>
                    ...
                    <img src={getImage(10)} className={styles.image}/>
                    ...
                    <img src={getImage(11)} className={styles.image}/>
                    ...
                    <img src={getImage(12)} className={styles.image}/>
                    <Text color={'#BABCDB'} className={styles.alignJustifiedText} indent={28}
                    ...
                    <img src={getImage(13)} className={styles.image}/>
                    <Text color={'#BABCDB'} className={styles.alignJustifiedText} indent={28}
                    ...
                    <img src={getImage(14)} className={styles.image}/>
                    ...
                    <img src={getImage(15)} className={styles.image}/>
                    <Text color={'#BABCDB'} className={styles.alignJustifiedText} indent={28}
                ...
                <div className={styles.ass}>
                    ...
                    <img src={mockupSrc} className={styles.imageButton} alt="Community Mockup" />
